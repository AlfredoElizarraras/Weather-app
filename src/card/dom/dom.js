...
export const celciusButton = () => {
  document.getElementById('temperature-button--celcius');
};

export const farenheitButton = () => {
  document.getElementById('temperature-button--farenheit');
};
  ...
  <div id="content">
    <div id="cardsContainer" class="cards-container">
      <div class="cards-container__temperature-buttons">
        <button class="temperature-button temperature-button--celcius active">
        ...
        <button class="temperature-button temperature-button--farenheit">
